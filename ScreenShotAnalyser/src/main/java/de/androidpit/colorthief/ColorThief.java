...
public class ColorThief {
    ...
    */
    ...
    public static int[] getColorIgnoreArea(BufferedImage sourceImage, Rect ignore) {
        int[][] palette = getPaletteIgnoreArea(sourceImage, 5, ignore);
        if (palette == null) {
            return null;
        }
        int[] dominantColor = palette[0];
    ...
    public static int[][] getPaletteIgnoreArea(BufferedImage sourceImage, int colorCount, Rect ignore) {
        CMap cmap = getColorMapIgnoreArea(sourceImage, colorCount, ignore);
        if (cmap == null) {
            return null;
        }
        return cmap.palette();
    }
    public static CMap getColorMapIgnoreArea(BufferedImage sourceImage, int colorCount, Rect ignore) {
        return getColorMapIgnoreArea(sourceImage, colorCount, ignore, DEFAULT_QUALITY, DEFAULT_IGNORE_WHITE);
    }
    public static CMap getColorMapIgnoreArea(
            BufferedImage sourceImage,
            int colorCount,
            Rect ignore,
            int quality,
    ...
    */
        default:
            pixelArray = getPixelsSlowIgnoreArea(sourceImage, quality, ignoreWhite, ignore);
        }
    ...
    private static int[][] getPixelsSlowIgnoreArea(
            BufferedImage sourceImage,
            int quality,
            boolean ignoreWhite,
            Rect ignore) {
